...
class FiniteDifferenceTest(unittest.TestCase):
    ...
    def test_generate(self):
        ...
        for acc, cases in REGULAR_GRID_CASES.items():
            for deriv, stencil in cases:
                with self.subTest(
        ...
        CELL_CENTERED_GRID_CASES = {
            2: [
                ...
                (5, [-2.5, -1.5, -0.5, 0.5, 1.5, 2.5]),
                (6, [-3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5]),
                (7, [-3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5]),
            ...
            4: [
                ...
                (8, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (9, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (
                    10,
                    [
                        -6.5,
            ...
            6: [
                ...
                (2, [-3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5]),
                (3, [-3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5]),
                (4, [-4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5]),
                (5, [-4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5]),
                (6, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (7, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (
                    8,
                    [
                        -6.5,
            ...
            8: [
                ...
                (4, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (5, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (
                    6,
                    [
                        -6.5,
            ...
            10: [
                ...
                (2, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (3, [-5.5, -4.5, -3.5, -2.5, -1.5, -0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5]),
                (
                    4,
                    [
                        -6.5,
        ...
        for acc, cases in CELL_CENTERED_GRID_CASES.items():
            for deriv, stencil in cases:
                with self.subTest(
                    f"generate {acc}-order central difference equation for {deriv}-derivative on cell-centered grid"
                ):
                ...
                with self.subTest(
                    f"generate {acc}-order central difference coefficients for {deriv}-derivative on cell-centered grid"
                ):
        ...
        for acc, cases in STAGGERED_GRID_CASES.items():
            for deriv, stencil in cases:
                with self.subTest(
                    f"generate {acc}-order central difference equation for {deriv}-derivative on staggered grid in inconsistent-form"
                ):
                ...
                with self.subTest(
                    f"generate {acc}-order central difference coefficients for {deriv}-derivative on staggered grid in inconsistent-form"
                ):
